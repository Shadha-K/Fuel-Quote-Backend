...
describe('validateCompleteProfile', () => {
  ...
  test('should return 400 with error message if full name length exceeds 50 characters', () => {
    ...
    req.body.fullName = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.';
    req.body.address1 = '123 Main St';
    req.body.city = 'City';
    req.body.state = 'ST';
    req.body.zipcode = '12345';
  ...
  test('should return 400 with error message if address 1 length exceeds 100 characters', () => {
    req.body.username = 'user_name123';
    req.body.fullName = 'John Doe';
    req.body.address1 = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.';
    req.body.city = 'City';
    req.body.state = 'ST';
    req.body.zipcode = '12345';
    validateCompleteProfile(req, res, next);
  ...
  test('should return 400 with error message if address 2 length exceeds 100 characters', () => {
    ...
    req.body.fullName = 'John Doe';
    req.body.address1 = '123 Main St';
    req.body.address2 = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.';
    req.body.city = 'City';
    req.body.state = 'ST';
    req.body.zipcode = '12345';
    validateCompleteProfile(req, res, next);
  ...
  test('should return 400 with error message if city length exceeds 100 characters', () => {
    ...
    req.body.fullName = 'John Doe';
    req.body.address1 = '123 Main St';
    req.body.city = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.';
    req.body.state = 'ST';
    req.body.zipcode = '12345';
    validateCompleteProfile(req, res, next);
